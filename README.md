...
- `default_network_code_for_currency(self, code: object)`
- `describe(self)`
- `edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params={})`
- `encode_margin_mode(self, mode: object)`
...
- `fetch_order_book_snapshot(self, client: Client, message: object, subscription: object)`
