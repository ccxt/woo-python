...
- `default_network_code_for_currency(self, code: Any)`
- `describe(self)`
- `edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params={})`
- `encode_margin_mode(self, mode: Any)`
- `get_asset_history_rows(self, code: Str = None, since: Int = None, limit: Int = None, params={})`
- `get_currency_from_chaincode(self, networkizedCode: Any, currency: Any)`
- `get_dedicated_network_id(self, currency: Any, params: dict)`
...
- `fetch_order_book_snapshot(self, client: Client, message: Any, subscription: Any)`
