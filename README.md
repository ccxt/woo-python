...
- `create_trailing_amount_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, trailingAmount: Num = None, trailingTriggerPrice: Num = None, params: dict = {})`
- `create_trailing_percent_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, trailingPercent: Num = None, trailingTriggerPrice: Num = None, params: dict = {})`
...
- `default_network_code_for_currency(self, code: str)`
- `describe(self)`
- `edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params: dict = {})`
- `encode_margin_mode(self, mode: Str)`
- `get_asset_history_rows(self, code: Str = None, since: Int = None, limit: Int = None, params={})`
- `get_currency_from_chaincode(self, networkizedCode: object, currency: object)`
- `get_dedicated_network_id(self, currency: object, params: dict)`
...
- `repay_margin(self, code: str, amount: float, symbol: Str = None, params: dict = {})`
...
- `v3_private_post_futures_defaultmarginmode_reset(request)`
- `v3_private_post_isolatedmargin_margin(request)`
...
- `v3_private_put_futures_defaultmarginmode(request)`
- `v3_private_put_futures_defaultmarginmode_symbol(request)`
...
- `v3_private_delete_asset_wallet_withdraw_withdrawid(request)`
...
- `fetch_order_book_snapshot(self, client: Client, message: dict, subscription: dict)`
...
- `un_watch_tickers(self, symbols: Strings = None, params: dict = {})`
...
- `set_positions_cache(self, client: Client, type: object, symbols: Strings = None)`
